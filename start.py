...
def vid(pathout, height, width, name):
    ...
    if not os.path.exists(res_dir):
        os.makedirs(res_dir)
    save_path = os.path.join(pathout, name + res_name)
    writer = cv2.VideoWriter(save_path, cv2.VideoWriter_fourcc(*"mp4v"), 24, (height, width))
...
def cycle(fileinput, fileoutput, maskinput, step, neighbor, height, width, name):
    ...
    cropwithoverlap_imgs(fileinput, "examples/v", 2, 2, 40, height, width)
    cropwithoverlap_imgs(maskinput, "examples/v_mask", 2, 2, height, width)

    os.system(f'{PATH_TO_PYTHON} test.py -n 1 --step {step} --neighbor_stride {neighbor} --model e2fgvi_hq --video ./examples/v/1 --mask ./examples/v_mask/1  --ckpt release_model/E2FGVI-HQ-CVPR22.pth --width 1000 --height 580')
    os.system(f'{PATH_TO_PYTHON} test.py -n 2 --step {step} --neighbor_stride {neighbor} --model e2fgvi_hq --video ./examples/v/2 --mask ./examples/v_mask/2  --ckpt release_model/E2FGVI-HQ-CVPR22.pth --width 1000 --height 580')
    os.system(f'{PATH_TO_PYTHON} test.py -n 3 --step {step} --neighbor_stride {neighbor} --model e2fgvi_hq --video ./examples/v/3 --mask ./examples/v_mask/3  --ckpt release_model/E2FGVI-HQ-CVPR22.pth --width 1000 --height 580')
    os.system(f'{PATH_TO_PYTHON} test.py -n 4 --step {step} --neighbor_stride {neighbor} --model e2fgvi_hq --video ./examples/v/4 --mask ./examples/v_mask/4  --ckpt release_model/E2FGVI-HQ-CVPR22.pth --width 1000 --height 580')
    ...
    vid(fileoutput, height, width, name)
